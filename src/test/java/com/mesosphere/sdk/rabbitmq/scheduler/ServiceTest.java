...
//        ticks.add(Send.offerBuilder("rabbitmq").build());
//        ticks.add(Expect.launchedTasks("rabbitmq-0-init"));
//        ticks.add(Send.taskStatus("rabbitmq-0-init", Protos.TaskState.TASK_ERROR).build());
//
...
//        ticks.add(Send.offerBuilder("rabbitmq").setPodIndexToReoffer(0).build());
//        ticks.add(Expect.launchedTasks("rabbitmq-0-node"));
//        ticks.add(Send.taskStatus("rabbitmq-0-node", Protos.TaskState.TASK_RUNNING).build());
//
